...
def extract_course_content(url):
    with sync_playwright() as p:
        ...
        # Sleep for 30 seconds to let me sign in
        ...
        section_url_elems = rootSoup.select("a.site-font-primary-color")
        ...
        for section_index in range(len(section_title_elems)):
            ...
            for video_index, video_card in enumerate(video_cards):
                ...
                page.wait_for_timeout(10_000) # wait for quite a bit to let all responses come in
